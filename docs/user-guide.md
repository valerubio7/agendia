...
El panel de WhatsApp muestra solo el estado público de la única conexión del negocio. La vinculación entrega un código temporal con expiración; las credenciales persistentes y claves Signal nunca aparecen en el navegador. Una conexión ya vinculada debe conservarse y no admite una segunda asociación.
